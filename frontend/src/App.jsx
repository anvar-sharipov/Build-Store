...
//   // Путь, где нужно скрыть боковые панели
//   const isFullScreenPage = pathname === "/purchase-invoices/new";
//   return (
//     <div
//       // className="flex flex-col  text-gray-800 bg-gray-900 dark:text-gray-100 min-h-screen p-4 text-xs sm:text-sm md:text-base print:min-h-0"
